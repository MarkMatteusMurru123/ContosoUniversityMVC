...
namespace ContosoUniversityMVC.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        private void PopulateAssignedCourseData(Instructor instructor) //The code in the PopulateAssignedCourseData method reads through all Course entities in order to load a list of courses using the view model class. For each course, the code checks whether the course exists in the instructor's Courses navigation property.
                                                                       ...
                                                                       //The Assigned property is set to true for courses the instructor is assigned to. The view will use this property to determine which check boxes must be displayed as selected. Finally, the list is passed to the view in ViewData
        {
        ...
        {
            if (selectedCourses == null)//If no check boxes were selected, the code in UpdateInstructorCourses initializes the CourseAssignments navigation property with an empty collection and returns:  
            {
            ...
            foreach (var course in _context.Courses)
                ...
                else
                {
                    ...
                    if (instructorCourses.Contains(course.CourseID)) //If the check box for a course wasn't selected, but the course is in the Instructor.CourseAssignments navigation property,
